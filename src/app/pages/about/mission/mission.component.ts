...
export class MissionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.metaTagsService.updateTags({
      ...
      description:
        'Nuestra misión es formar jóvenes íntegros a través del deporte, promoviendo valores y brindando oportunidades de crecimiento personal y social.',
      keywords:
        'CD Futuro 13, misión, formación, jóvenes, valores, deporte, comuna 13',
      url: 'https://corporaciondeportivafuturo13.com/about/mission',
      type: 'website',
    });
  }
}
