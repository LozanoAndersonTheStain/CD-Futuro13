...
export class TestimonialsComponent implements OnInit {
  ...
  cardConfigs: CardConfig[] = [
    {
      ...
      description:
        'Descubre que opinan de los padres sobre la formación brindada por el club.',
    ...
    },
    {
      ...
      description:
        'Nuestros alumnos cuentan sus experiencias con el club y como los ha cambiado.',
      buttonLabel: 'Ver Testimonios',
  ...
  ngOnInit(): void {
    this.metaTagsService.updateTags({
      ...
      keywords:
        'CD Futuro 13, testimonios, formación, jóvenes, comuna 13, padres, alumnos',
      url: 'https://corporaciondeportivafuturo13.com/testimonials',
      type: 'website',
    });
  }
}
